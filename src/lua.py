...
I_N_DATA_PATH = r'D:\工作区\I-N-Data'
...
# decode_luas()
decode_lua_bytecode(r'script', I_N_DATA_PATH + r'\X6Game\Content\Script\GenV2\Cfg\1634995571.lua')
decode_lua_bytecode(r'script', I_N_DATA_PATH + r'\X6Game\Content\Script\GenV2\Cfg\1759129374.lua')
